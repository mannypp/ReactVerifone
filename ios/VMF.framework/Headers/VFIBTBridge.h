...
/**
 * Singleton instance of VFIBTBridge utilized by VFIPinpad
 */
+ (VFIBTBridge *)sharedController;

-(void) setVMFThread:(NSThread*)thread;
-(NSThread*) getVMFThread;

@property (nonatomic, strong) NSThread* vmfThread;
