...
#import "VFI_swipeData.h"
#import "VFI_decryptedCredentials.h"
...
@required
- (void) accessoryDataReceived:(AccMessage)message data:(VFI_swipeData*)card;//!<This required delegate protocol monitors all data messages and receives swipe data.
 ...
 *
 */
-(VFI_decryptedCredentials*) decryptCredentials:(NSString*)credentials;
/**
...
#else
    @property (nonatomic, strong) VFIPayware *gen1; //!<Access to the VFIPAYware class for controlling the sled MSR hardware.
    @property (nonatomic, strong) VFIPinpad *pinpad; //!< Access to the VFIPinpad class for controlling the e210/e255/e315 hardware
    @property (nonatomic, strong) VFIaudioMSR *uniReader; //!< Access to the VFIaudioMSR class for controlling the audio MSR hardware.
    @property (nonatomic, strong) VFIConnect *_vfiConnect; //!< Singleton instance of VFIConnect. For internal use only.
#endif
