...
#else
    @property (nonatomic, strong) NSString *PANLow;
    @property (nonatomic, strong) NSString *PANHigh;
    @property (nonatomic, strong) NSString *cardAbbreviation;
    @property (nonatomic, strong) NSString *cardLabel;
    @property (nonatomic, strong) NSString *issuerLabel;
#endif
