...
@interface VFIEMVResponse : NSObject {
    ...
    int recordNumber;               //!< Record# return from D10 command
    NSData *retrievedData;          //!< Retrieved field data returned from D10 command
}
 ...
 */
+ (VFIEMVResponse *)sharedController;
    ...
    @property (nonatomic, retain) NSData *retrievedData;
#else
    @property (nonatomic, strong) NSData *macBlock;
    @property (nonatomic, strong) NSData *tpkKey;
    @property (nonatomic, strong) NSData *takKey;
    @property (nonatomic, strong) NSData *macData;
    @property int hostDecision;
    @property BOOL displayResult;
    @property (nonatomic, strong) NSData *hostTagString;
    @property int scriptId;
    @property BOOL clearBeforeScriptWrite;
    @property int numberOfScripts;
    @property int scriptLength;
    @property (nonatomic, strong) NSData *scriptData;
    @property int recordNumber;
    @property (nonatomic, strong) NSData *retrievedData;
#endif
