...
#else
    @property (nonatomic, strong) VFICardData* cardData;
    @property (nonatomic, strong) VFIEncryptionData* encryptedData;
    @property (nonatomic, strong) NSMutableDictionary* emvTags;
    @property (nonatomic, strong) VFIEMVAuthorization *emvAuthorization;
    @property (nonatomic, strong) VFIDataEntry *cardholderEntries;
    @property (nonatomic, strong) NSMutableArray *additionalPrompts;
    @property (nonatomic, strong) NSMutableArray *additionalPromptResponses;
#endif
