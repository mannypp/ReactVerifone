...
-(void)clear;
    ...
    @property int blackListCardSupportFlag;
    @property int fallbackAllowedFlag;
    @property (nonatomic, strong) NSString *tacDefault;
    @property (nonatomic, strong) NSString *tacDenial;
    @property (nonatomic, strong) NSString *tacOnline;
    @property (nonatomic, strong) NSString *defaultTDOL;
    @property (nonatomic, strong) NSString *defaultDDOL;
    @property int autoSelectApplication;
    @property (nonatomic, strong) NSString *countryCode;
    @property (nonatomic, strong) NSString *currencyCode;
    @property (nonatomic, strong) NSString *terminalCapacity;
    @property (nonatomic, strong) NSString *additionalCapacity;
    @property (nonatomic, strong) NSString *terminalType;
    @property (nonatomic, strong) NSString *merchantCategoryCode;
    @property (nonatomic, strong) NSString *terminalCategoryCode;
    @property (nonatomic, strong) NSString *terminalID;
    @property (nonatomic, strong) NSString *merchantID;
    @property (nonatomic, strong) NSString *acquireID;
    @property (nonatomic, strong) NSString *capkIndex;
    @property (nonatomic, strong) NSString *pinBypassFlag;
    @property (nonatomic, strong) NSString *pinTimeout;
    @property (nonatomic, strong) NSString *pinFormat;
    @property (nonatomic, strong) NSString *pinScriptNumber;
    @property (nonatomic, strong) NSString *pinMacroNumber;
    @property (nonatomic, strong) NSString *pinDevriKey;
    @property (nonatomic, strong) NSString *pinDevriMacro;
    @property (nonatomic, strong) NSString *cardStatusDisplay;
    @property int termCurExp;
    @property int issAcqFlag;
    @property int noDisplaySupportFlag;
    @property int modifyCandidateListFlag;
    @property (nonatomic, strong) NSString *rfu1String;
    @property (nonatomic, strong) NSString *rfu2String;
    @property (nonatomic, strong) NSString *rfu3String;
    @property int vfi_rfu1;
    @property int vfi_rfu2;
    @property int vfi_rfu3;
#endif
