 ...
 *
 ...
 ~~~~~~~~~~~~~~~~~~~~~
  var barcode: code VFIBarcode = VFIBarcode()
 ~~~~~~~~~~~~~~~~~~~~~
 *
 */
-(id)init;
 ...
 *
 ...
 ~~~~~~~~~~~~~~~~~~~~~
  var frame: code ISCP_HIGH = ISCP_HIGH()
  frame.commandType = TYPE_SETUP_WRITE
  frame.group = 0x4a
  frame.fid = 0x40
  var bytes: UInt8 = 0x01
  frame.param = NSData(bytes: bytes, length: 1)
  e210 / e255 / e315.barcode().sendISCP(frame)
  ~~~~~~~~~~~~~~~~~~~~~
 *
 */
